...
def main():
    ...
    if len(df) > 10000:
        ...
        print(f"데이터를 42000개로 제한했습니다. (원본: {len(pd.read_csv(csv_file))}개)")
    else:
    ...
    # trainer.train(epochs=5, save_path="/home/thkim/dev/eda/Toon_Persona_eda/best_resnet_caption_model.pth")
