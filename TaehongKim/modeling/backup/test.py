...
def main():
    ...
    if len(df) > 100:
        ...
        print(f"데이터를 10개로 제한했습니다. (원본: {len(pd.read_csv(csv_file))}개)")
    else:
    ...
    # 임시 CSV 파일 생성
    train_df.to_csv("/home/thkim/dev/eda/Toon_Persona_eda/test_train_temp.csv", index=False)
    val_df.to_csv("/home/thkim/dev/eda/Toon_Persona_eda/test_val_temp.csv", index=False)
    
    # 데이터로더 생성
    train_dataset = ImageCaptionDataset("/home/thkim/dev/eda/Toon_Persona_eda/test_train_temp.csv", all_image_dir, tokenizer, transform)
    val_dataset = ImageCaptionDataset("/home/thkim/dev/eda/Toon_Persona_eda/test_val_temp.csv", all_image_dir, tokenizer, transform)
    ...
    trainer.train(epochs=10, save_path="/home/thkim/dev/eda/Toon_Persona_eda/test_caption_model.pth")
    ...
    # 임시 파일 정리
    os.remove("/home/thkim/dev/eda/Toon_Persona_eda/test_train_temp.csv")
    os.remove("/home/thkim/dev/eda/Toon_Persona_eda/test_val_temp.csv")
